...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td></td>
            <td>:</td>
            <td>Orang tersebut benar-benar penduduk Desa Wringinanom Kecamatan Sambit Kabupaten Ponorogo dan termasuk keluarga ekonominya benar benar tergolong tidak mampu .</td>
        </tr>
    </table>

    <div style="margin-top: 1rem;">
        <p style="margin-left:1rem;">Surat keterangan ini diberikan untuk mengajukan bantuan biaya Sekolah/kuliah anaknya:</p>
    </div>
    <table>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td></td>
            <td>:</td>
            <td>{{$data['tempat_lahir_child']}}, {{\Carbon\Carbon::parse($data['tgl_lahir_child'])->locale('id')->translatedFormat('d F Y')}}</td>
        </tr>
        <tr>
            <td></td>
            <td>3.</td>
    ...
    <div style="margin-top:3rem; position: relative">
        <div style="position: absolute; left: 5rem">
            <div style="text-align: center;">
                ...
                <p style="text-align: center; font-weight:bold; text-decoration: underline">{{$data['name']}}</p>
            </div>
        </div>
    </div>

    <div style="position: relative">
        <div style="position: absolute; top: -1.7rem; right: 5rem">
